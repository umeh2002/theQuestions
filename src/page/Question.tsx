  ...
  const data = [
    {
      id: 1,
      question:
        "Which of the following css property is used to make an element move from a particular direction to another...",
    ...
    },
    {
      id: 2,
      question:
        "Which of the following css property is used to make an element move horizontally from a particular direction to another...",
    ...
    },
    {
      id: 3,
      question:
        "Which of the following css property is used to make an element move vertically from a particular direction to another...",
      answer: "align-items",
      a: "flex-start",
      b: "space-around",
      c: "justify-content",
    ...
    },
    {
      id: 8,
      question:
        "The extension that is used when creating an HTML File is called...",
    ...
    },
    {
      id: 9,
      question:
        "Which of the following term is used when refering to defining the skeleton of a webpage...",
      answer: "HTML",
      a: "HTML",
      b: "CSS",
      c: "Boxification",
    ...
    },
    {
      id: 12,
      question:
        "Browser used in viewing your result when done coding are all except one ",
      answer: "Google Earth",
      a: "Google chrome",
      b: "Firefox",
      c: "Google Earth",
    ...
    },
    {
      id: 13,
      question:
        "What property is used to change the default color of a text to another color",
      answer: "color",
      a: "background-color",
      b: "border-color",
      c: "text-color",
    ...
    },
    {
      id: 17,
      question:
        "Which of the following symbols signifies that a particular tag has a 'Class' ",
      answer: ".",
      a: "*",
      b: "-",
      c: "!",
    ...
    },
    {
      id: 18,
      question:
        "Which of the following symbols signifies that a particular tag has an 'ID' ",
      answer: "#",
      a: "*",
      b: "-",
      c: "$",
    ...
    },
    {
      ...
      answer:
        "It is used to declare the type of document that is being created.",
    ...
    },
    {
      id: 24,
      question:
        "Which CSS property enables the manipulation of spaces around a container?",
      answer: "margin",
      a: "margin",
      b: "padding",
      c: "flex",
    ...
    },
    {
      id: 25,
      question:
        "Which CSS property enables the manipulation of spaces inside of a container?",
      answer: "padding",
      a: "margin",
      b: "padding",
      c: "flex",
    ...
    },
    {
      id: 27,
      question:
        "What is the CSS property for containing the exceedings of elements in a container?",
      answer: "flex-wrap",
      a: "flex",
      b: "flex-direction",
      c: "contain",
    ...
    },
    {
      id: 29,
      question:
        "What is the CSS property for smoothen the straight edges of an element?",
      answer: "border-arc",
      a: "border-line",
      b: "curver",
      c: "border-arc",
    ...
    },
    {
      id: 6,
      question:
        "What is the difference between inline CSS, embedded CSS, and external CSS?",
      answer:
        "Inline CSS is placed inside the HTML document, embedded CSS is placed outside the `<head>` tag, and external CSS is placed in a separate file.",
